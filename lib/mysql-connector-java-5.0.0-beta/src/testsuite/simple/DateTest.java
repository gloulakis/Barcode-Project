 ...
 * @version $Id: DateTest.java 4251 2005-09-15 15:41:26Z mmatthews $
 */
public class DateTest extends BaseTestCase {
	...
	public void testZeroDateBehavior() throws Exception {
		try {
			...
			// JDK-1.3 formats this differently :p
			
			String allOnesTimestamp = null;
			
			if (!isRunningOnJdk131()) {
				allOnesTimestamp = "0001-01-01 00:00:00.0";
			} else {
				allOnesTimestamp = "1-01-01 00:00:00.0";
			}
			
			assertEquals(allOnesTimestamp, this.rs.getTimestamp(1)
					.toString());
			assertEquals("0001-01-01", this.rs.getDate(2).toString());
			assertEquals(allOnesTimestamp, this.rs.getTimestamp(2)
					.toString());
